...
3. **Tạo trang web mới**:
   ...
   - Sử dụng các tùy chọn mặc định và nhập tên người dùng, mật khẩu, cùng email của các em.
   - Nhấn **Add Site** để hoàn tất.

4. **Khởi động trang web**:
   - Nhấn **Start Site** ở góc trên cùng bên phải.
   - Nhấn **View Site** để xem trang web WordPress cục bộ của các em.
...
- **wp-content**: Chứa các tệp hệ thống của WordPress.
  ...
  - Trong khóa học này, thầy trò mình sẽ tạo một thư mục mới tại đây để phát triển chủ đề tùy chỉnh.
...
Hy vọng bài viết này giúp các em thiết lập môi trường phát triển WordPress một cách dễ dàng. Trong bài học tiếp theo, thầy trò mình sẽ bắt đầu tìm hiểu về PHP, ngôn ngữ cốt lõi của WordPress. Hãy chuẩn bị tinh thần, thầy trò mình sẽ bắt đầu viết mã ngay
