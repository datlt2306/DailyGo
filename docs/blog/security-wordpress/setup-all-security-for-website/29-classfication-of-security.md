...
### 1. Basic (Cơ bản)
- **An toàn nhất**: Các biện pháp cơ bản là những biện pháp bảo mật an toàn và không gây ảnh hưởng đến website.
- **Ví dụ**: Thay đổi tên người dùng admin (Change Admin Username).
...
- **Ví dụ**: Các biện pháp bảo mật cơ sở dữ liệu (Database Security).
...
### Bước 1: Kích hoạt biện pháp cơ bản
1. Vào **WP Security** > **User Security**, **Database Security**, hoặc **Firewall**.
2. Kích hoạt tất cả các biện pháp cơ bản.

### Bước 2: Kích hoạt biện pháp trung cấp
1. Sao lưu cơ sở dữ liệu trước khi kích hoạt.
2. Kích hoạt từng biện pháp trung cấp.

### Bước 3: Kích hoạt biện pháp nâng cao
1. Để website chạy ổn định với các biện pháp cơ bản và trung cấp trong **1-2 tuần**.
2. Vào **Settings** > **Import/Export** và xuất cài đặt bảo mật.
3. Kích hoạt từng biện pháp nâng cao:
   - Kích hoạt một biện pháp.
...
- **Xuất cài đặt bảo mật**: Luôn xuất cài đặt trước khi kích hoạt biện pháp nâng cao.
...
- **Basic**: An toàn nhất, kích hoạt tất cả.
- **Intermediate**: Rủi ro thấp, sao lưu trước khi kích hoạt.
