# Cài đặt scanner trong plugin "All In One Security": Từ Thầy Đạt
...
- **Chức năng**: Quét và chụp snapshot các file trên website để phát hiện thay đổi.
- **Cách thực hiện**:
  1. Vào **Scanner Settings** > **File Change Detection**.
  2. Nhấn **Scan** để thực hiện quét lần đầu.
  3. Kích hoạt **Automated File Change Detection Scan**.
  4. Chọn tần suất quét (ví dụ: 4 tuần).
  5. Thêm các loại file hoặc thư mục cần bỏ qua (ví dụ: file ảnh hoặc thư mục cache).
  6. Kích hoạt tùy chọn nhận email khi phát hiện thay đổi file.
  7. Lưu cài đặt.
