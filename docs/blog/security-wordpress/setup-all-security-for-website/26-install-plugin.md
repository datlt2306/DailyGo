...
### Các bước thực hiện
1. Vào **Dashboard** > **Plugins** > **Add New**.
2. Tìm kiếm plugin với từ khóa **All In One Security**.
3. Chọn plugin có tên **All In One Security & Firewall** của **David Anderson và Team Updraft**.
...
### Giao diện plugin
- Sau khi kích hoạt, các em sẽ thấy một mục mới **WP Security** xuất hiện ở thanh menu bên trái.
- Trên màn hình **Dashboard**, plugin sẽ hiển thị **Strength Meter** – thước đo mức độ bảo mật hiện tại của website.

### Strength Meter
- **Điểm hiện tại**: Plugin sẽ hiển thị điểm bảo mật hiện tại của website (ví dụ: 15 điểm).
- **Tổng điểm khả thi**: Plugin cho biết tổng số điểm bảo mật mà website có thể đạt được (520 điểm).
...
- **Cài đặt plugin**: Tìm kiếm và cài đặt **All In One Security & Firewall** từ WordPress Plugin Repository.
