...
|:---:|:-----|:-------|:----------|
| 01 | [01-intro-to-git.md](./01-intro-to-git.md) | Giới thiệu về Git và Version Control | Tìm hiểu Git là gì, tại sao cần dùng, và khác biệt với GitHub |
| 02 | [02-install-config.md](./02-install-config.md) | Cài đặt & cấu hình Git | Hướng dẫn cài đặt Git trên Windows, macOS, Linux và cấu hình cơ bản |
| 03 | [03-git-basic-commands.md](./03-git-basic-commands.md) | Các lệnh cơ bản | Học `init`, `add`, `commit`, `status`, `log` - workflow cơ bản |
| 04 | [04-working-directory.md](./04-working-directory.md) | Hiểu Working Directory và Staging Area | Nắm rõ 3 khu vực: Working Directory, Staging Area, Repository |
| 05 | [05-git-branching.md](./05-git-branching.md) | Làm việc với Branch | Tạo, quản lý branch, merge branch - nền tảng cho teamwork |
| 06 | [06-merge-vs-rebase.md](./06-merge-vs-rebase.md) | Merge và Rebase | Phân biệt merge vs rebase, khi nào dùng cái nào, xử lý conflict |
| 07 | [07-github-intro.md](./07-github-intro.md) | Giới thiệu GitHub | Tạo tài khoản, repository, kết nối local với GitHub |
| 08 | [08-collaboration.md](./08-collaboration.md) | Làm việc nhóm với GitHub | Clone, fork, push, pull - workflow làm việc nhóm cơ bản |
| 09 | [09-github-flow.md](./09-github-flow.md) | GitHub Flow | Quy trình teamwork chuẩn: branch → develop → PR → merge |
| 10 | [10-pull-request.md](./10-pull-request.md) | Pull Request và Review Code | Tạo PR chuyên nghiệp, review code, xử lý conflict trong PR |
| 11 | [11-commit-best-practices.md](./11-commit-best-practices.md) | Commit Message Best Practices | Conventional Commits, viết commit message chuyên nghiệp |
| 12 | [12-git-advanced.md](./12-git-advanced.md) | Git Nâng cao | Stash, revert, reset, cherry-pick - các lệnh nâng cao |
| 13 | [13-common-errors.md](./13-common-errors.md) | Lỗi thường gặp và khắc phục | Tổng hợp lỗi phổ biến và cách xử lý, phòng tránh |
| 14 | [14-git-tag-release.md](./14-git-tag-release.md) | Tag và phát hành phiên bản | Semantic versioning, tạo tag, release trên GitHub |
| 15 | [15-mini-project.md](./15-mini-project.md) | Mini Project | Dự án cuối khóa: Làm việc nhóm theo GitHub Flow |
